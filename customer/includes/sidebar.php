...
<div id="bottom-nav" class="fixed bottom-0 left-0 right-0  shadow-lg border-t border-gray-200 z-20">
    <div class="flex justify-around items-center h-16">
        ...
        <!-- Membership -->
        <a href="membership.php" class="flex flex-col items-center justify-center w-full h-full <?php echo $current_page == 'membership.php' ? 'text-[#FF6B45]' : 'text-gray-600'; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <!-- Classes -->
        <a href="classes.php" class="flex flex-col items-center justify-center w-full h-full <?php echo $current_page == 'classes.php' ? 'text-[#FF6B45]' : 'text-gray-600'; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <!-- Notifications -->
        <a href="notification.php" class="flex flex-col items-center justify-center w-full h-full <?php echo $current_page == 'notification.php' ? 'text-[#FF6B45]' : 'text-gray-600'; ?>">
            <div class="relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <!-- Profile -->
        <a href="profile.php" class="flex flex-col items-center justify-center w-full h-full <?php echo $current_page == 'profile.php' ? 'text-[#FF6B45]' : 'text-gray-600'; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div id="more-menu-modal" class="fixed inset-0 bg-black bg-opacity-50 z-30 hidden flex items-end justify-center">
    <div class="bg-white rounded-t-xl w-full max-w-md p-4 animate-slide-up">
        ...
        <div class="grid grid-cols-3 gap-4">
            <!-- Workouts -->
            <a href="workouts.php" class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-100">
            ...
            <!-- WhatsApp Test -->
            <a href="test.php" class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-600 mb-1">
            ...
            <!-- Settings -->
            <a href="settings.php" class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-600 mb-1">
            ...
            <!-- Help -->
            <a href="help.php" class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-600 mb-1">
            ...
            <!-- Logout -->
            <a href="logout.php" class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-600 mb-1">
