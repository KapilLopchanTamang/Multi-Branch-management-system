...
<body>
            ...
            <div class="dashboard-content">
                <?php if (isset($_SESSION['admin_added'])): ?>
                    <div class="success-message">
                        <?php echo $_SESSION['admin_added']; unset($_SESSION['admin_added']); ?>
                    </div>
                <?php endif; ?>
                
                <?php if (isset($_SESSION['branch_added'])): ?>
                    <div class="success-message">
                        <?php echo $_SESSION['branch_added']; unset($_SESSION['branch_added']); ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if (isset($_SESSION['branch_errors'])): ?>
                    <div class="error-message">
                        <ul>
                            <?php foreach ($_SESSION['branch_errors'] as $error): ?>
                                <li><?php echo $error; ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    <?php unset($_SESSION['branch_errors']); ?>
                <?php endif; ?>
                <!-- Stats Cards -->
                ...
                <!-- Branches Section -->
                <div class="section">
                    <!-- Update the Add Branch button to open the modal -->
                    <div class="section-header">
                        <h2>Branches</h2>
                        <button class="add-btn" onclick="showAddBranchModal()">
    ...
    <div id="addBranchModal" class="modal">
        <div class="modal-content">
            ...
            <form id="addBranchForm" action="add_branch.php" method="post">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="branch_admin">Assign Admin (Optional)</label>
                    <select id="branch_admin" name="branch_admin">
                        <option value="">Select Admin</option>
                        <?php 
                        // Reset branch admins result pointer
                        $branch_admins->data_seek(0);
                        while ($admin = $branch_admins->fetch_assoc()): 
                            // Only show admins that don't have a branch assigned
