...
<body>
        ...
        <div class="main-content">
            ...
            <div class="dashboard-content">
                <?php if (isset($_SESSION['settings_message'])): ?>
                    <div class="<?php echo $_SESSION['settings_message_type'] === 'success' ? 'success-message' : 'error-message'; ?>">
                ...
                <div class="settings-container">
                        ...
                        <div class="settings-card">
                            ...
                            <div class="settings-group">
                                ...
                                <div class="settings-option">
                                    ...
                                    <div class="settings-description">
                                        The maximum number of times a customer can check in per day.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="settings-card">
                        ...
                        <div class="settings-group">
                            ...
                            <div class="settings-option">
                                <button type="button" class="settings-btn reset" onclick="confirmDataCleanup()">
                            ...
                            <div class="settings-option">
                                <button type="button" class="settings-btn reset" onclick="confirmAutoCheckout()">
    ...
    <script>
        ...
        function confirmDataCleanup() {
            if (confirm('Are you sure you want to remove attendance records older than 1 year? This action cannot be undone.')) {
                alert('Data cleanup functionality will be implemented here');
                // In a real implementation, you would make an AJAX call to a server-side script
            }
        }
        
        // Confirm auto check-out
        function confirmAutoCheckout() {
            if (confirm('Are you sure you want to automatically check out all customers who are currently checked in?')) {
                alert('Auto check-out functionality will be implemented here');
                // In a real implementation, you would make an AJAX call to a server-side script
            }
        }
    </script>
